  ...
  const mailOptions = {
    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: auto; padding: 20px; border: 1px solid #dcdcdc; border-radius: 10px;">
        ...
        <p>Εάν εσείς επιχειρήσατε τη σύνδεση, μπορείτε είτε να περιμένετε το απαιτούμενο χρονικό διάστημα και να προσπαθήσετε ξανά να συνδεθείτε, είτε να αλλάξετε τον κωδικό σας πατώντας το κουμπί 'Αλλαγή Κωδικού'. Έτσι, ο λογαριασμός σας θα είναι άμεσα προσβάσιμος.</P>
        <P><b>Εάν δεν ήσασταν εσείς που επιχειρήσατε την είσοδο</b>, σας προτείνουμε να αλλάξετε τον κωδικό σας το συντομότερο δυνατόν.</p>
        <a href="http://${process.env.HOST}/validate/change-password?token=${token}" style="display: inline-block; padding: 10px 20px; margin: 10px 0; font-size: 16px; color: #fff; background-color: #4CAF50; text-align: center; text-decoration: none; border-radius: 5px;">Επιβεβαίωση e-mail</a>
